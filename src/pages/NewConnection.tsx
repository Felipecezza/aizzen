...
import { Loader2, RefreshCcw, QrCode, Clock, CheckCircle2 } from "lucide-react";
...
// Página de conexão com Layout padrão
const NewConnection = () => {
  ...
  const checkConnectionStatus = async () => {
    ...
    try {
      ...
      const response = await fetch(webhookApi.VERIFICAR_CONEXAO, {
        method: 'POST',
        headers: {
  ...
  const handleGenerateQRCode = async () => {
    ...
    try {
      ...
      const response = await fetch(webhookApi.CRIAR_INSTANCIA, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
  ...
  const refreshQRCode = async (instanceNameToRefresh = fullInstanceName) => {
    try {
      ...
      const response = await fetch(webhookApi.ATUALIZAR_QR_CODE, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
  ...
  }, [user, fullInstanceName]);

  return (
    <Layout>
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-4 lg:mb-8">
          <h2 className="text-2xl lg:text-3xl font-bold tracking-tight text-white">Conectar WhatsApp</h2>
        ...
        <div className="space-y-4 lg:space-y-8">
          {showConnectionForm ? (
            <Card className="bg-dark-700 border-zinc-800">
              <CardHeader>
                <CardTitle className="text-white text-lg lg:text-xl">Conectar Nova Instância</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4 lg:space-y-6">
                <div className="space-y-2">
                  ...
                  <Input 
                    ...
                    className="border-zinc-700 text-white bg-dark-500" 
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex">
                    ...
                    <Input 
                      ...
                      maxLength={13} 
                      className="border-zinc-700 text-white rounded-l-none bg-dark-500" 
                    />
                  </div>
                </div>
            ...
            <Card className="bg-dark-700 border-zinc-800">
              <CardHeader className="text-center">
                ...
                {connectionStatus === "active" && (
                  <div className="mt-4 bg-green-900/20 border border-green-800 text-green-300 p-3 rounded-md text-center">
                  ...
                  <div className="flex flex-col items-center space-y-6">
                    ...
                    <div className="w-full">
                      <Button 
                        ...
                        className="w-full flex items-center justify-center bg-zinc-800 hover:bg-zinc-700 border border-zinc-700 text-white" 
                        disabled={isQrLoading || connectionStatus === "active"}
                      >
                        {isQrLoading ? (
                          <>
                            <Loader2 className="mr-2 h-4 w-4 animate-spin" />
                        ...
                        <div>
                          ...
                          {pairingCode ? (
                            ...
                            <p className="text-zinc-400 text-sm font-medium">
                              Toque em <span className="text-zinc-300">Conectar um dispositivo</span> e escaneie o QR Code
                            </p>
                          )}
                        </div>
                      </div>
          ...
          <Card className="bg-dark-700 border-zinc-800">
            <CardHeader>
              <CardTitle className="text-white text-lg lg:text-xl">Contas Conectadas</CardTitle>
            </CardHeader>
            <CardContent>
